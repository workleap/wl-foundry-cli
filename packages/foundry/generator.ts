...
const ReplaceInFile = async (filePath: string, templates: { [key: string]: string }): Promise<void> => {
...
export const AddToReplace = (filePath: string, templates: { [key: string]: string }): void => {
